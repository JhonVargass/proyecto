<?php
	...
	$consulta = "SELECT * FROM insertarclientes";
	...
	if($resultado->num_rows > 0 ){
		...
		$titulosColumnas = array('id', 'Codigo', 'Nombre', 'Apellido', 'Sexo', 'FechaNacimiento', 'Telefono', 'Direccion', 'Correo');
		...
		while ($fila = $resultado->fetch_array()) {
			$objPHPExcel->setActiveSheetIndex(0)
        		    ...
        		    ->setCellValue('H'.$i,  $fila['Correo'])
            		->setCellValue('I'.$i, utf8_encode($fila['Codigo']));
		...
		$objPHPExcel->getActiveSheet()->getStyle('A5:D5')->applyFromArray($estiloTituloReporte);
		$objPHPExcel->getActiveSheet()->getStyle('A6:D6')->applyFromArray($estiloTituloColumnas);
		$objPHPExcel->getActiveSheet()->getStyle('A7:D7')->applyFromArray($estiloTituloReporte);
		$objPHPExcel->getActiveSheet()->getStyle('A8:D8')->applyFromArray($estiloTituloColumnas);
		$objPHPExcel->getActiveSheet()->getStyle('A9:D9')->applyFromArray($estiloTituloReporte);
		...
		header('Content-Disposition: attachment;filename="ReportedeU.xlsx"');
